...
# Install packages
sudo pacman -S amd-ucode grub ufw networkmanager network-manager-applet wpa_supplicant mesa lib32-mesa xf86-video-amdgpu vulkan-radeon lib32-vulkan-radeon libva-mesa-driver lib32-libva-mesa-driver mesa-vdpau lib32-mesa-vdpau vulkan-icd-loader lib32-vulkan-icd-loader vulkan-headers vulkan-validation-layers vulkan-tools gnome-system-monitor hyprland hyprpaper wf-recorder man-pages iniparser dialog reflector cups xdg-utils xdg-user-dirs libsecret bluez bluez-utils blueberry linux-headers zenity samba whois dosfstools mtools bash-completion ark syncthing sddm weston layer-shell-qt layer-shell-qt5 xorg-xwayland wayland xdg-desktop-portal-wlr xdg-desktop-portal waybar refind pipewire lib32-pipewire pipewire-jack lib32-pipewire-jack pipewire-pulse pipewire-alsa pavucontrol sddm-kcm nerd-fonts terminus-font noto-fonts noto-fonts-cjk noto-fonts-emoji ttf-inconsolata papirus-icon-theme cmake gcc ntfs-3g fastfetch htop nmap sqlmap git firefox thunar gvfs sshfs gvfs-smb seahorse gnome-keyring libsecret thunar-archive-plugin thunar-media-tags-plugin thunar-shares-plugin thunar-volman tumbler ffmpegthumbnailer libgsf webp-pixbuf-loader gnome-themes-extra nwg-look thunderbird gnome-calculator gimp krita handbrake libreoffice-still steam mangohud gamescope bitwarden mpv tlp dunst rofi-wayland rofi-emoji qbittorrent cmus ranger torbrowser-launcher weechat ruby tcl tor nyx gfeeds neovim mousepad obs-studio discord wine blender veracrypt copyq wl-clipboard retroarch retroarch-assets-xmb retroarch-assets-ozone libretro-core-info monero monero-gui reaper obsidian openvpn networkmanager-openvpn feh exa okular kleopatra soundconverter strawberry gst-libav gst-plugins-bad gst-plugins-base gst-plugins-good gst-plugins-ugly
